...
export const FEATURE_API_PATHS=[
  ...
  '/v1/clients/query','/v1/clients/create','/v1/clients/contacts/create','/v1/clients/contacts/eligibility',
  '/v1/projects/query','/v1/projects/create','/v1/projects/client-visibility',
