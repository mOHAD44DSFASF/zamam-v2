...
const eventPolicies: Readonly<Record<string, NotificationEventPolicy>> = {
  ...
  'task.step_reassigned': { titleKey: 'notification.task.step_reassigned', previewKey: 'notification.open_securely', critical: false, externalAllowed: true, resourceType: 'task' },
...
const messageLabels: Readonly<Record<string, string>> = {
  ...
  'notification.task.step_reassigned': 'تم تحويل خطوة مهمة',
